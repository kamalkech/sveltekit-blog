...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-87fc3d94.js", "src/routes/index.svelte": "pages/index.svelte-a28268d0.js", "src/routes/contact.svelte": "pages/contact.svelte-28978096.js", "src/routes/about.svelte": "pages/about.svelte-6ecd7ad3.js", "src/routes/blogs/index.svelte": "pages/blogs/index.svelte-7efddecb.js", "src/routes/blogs/[id].svelte": "pages/blogs/[id].svelte-e8edc0c3.js", "src/routes/post.svelte": "pages/post.svelte-42bd9dd0.js"};
const manifest = {
  assets: [{file: "favicon.ico", size: 1150, type: "image/vnd.microsoft.icon"}, {file: "images/about-bg.jpg", size: 2547880, type: "image/jpeg"}, {file: "images/contact-bg.jpg", size: 500680, type: "image/jpeg"}, {file: "images/favicon.ico", size: 1150, type: "image/vnd.microsoft.icon"}, {file: "images/home-bg.jpg", size: 1007801, type: "image/jpeg"}, {file: "images/post-bg.jpg", size: 1803228, type: "image/jpeg"}, {file: "robots.txt", size: 67, type: "text/plain"}],
  ...
  routes: [
    {
      ...
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/index.svelte-a28268d0.js"]
    },
    {
      type: "page",
      pattern: /^\/contact\/?$/,
      params: empty,
      parts: [{id: "src/routes/contact.svelte", load: components[1]}],
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/contact.svelte-28978096.js"]
    },
    {
      type: "page",
      pattern: /^\/about\/?$/,
      ...
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/about.svelte-6ecd7ad3.js"]
    },
    {
      type: "page",
      pattern: /^\/blogs\/?$/,
      params: empty,
      parts: [{id: "src/routes/blogs/index.svelte", load: components[3]}],
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/blogs/index.svelte-7efddecb.js"]
    },
    {
      type: "page",
      pattern: /^\/blogs\/([^/]+?)\/?$/,
      params: (m) => ({id: d(m[1])}),
      parts: [{id: "src/routes/blogs/[id].svelte", load: components[4]}],
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/blogs/[id].svelte-e8edc0c3.js"]
    },
    {
      type: "page",
      pattern: /^\/post\/?$/,
      params: empty,
      parts: [{id: "src/routes/post.svelte", load: components[5]}],
      css: ["assets/start-b9a13063.css"],
      js: ["start-87fc3d94.js", "chunks/vendor-9fb48351.js", "pages/post.svelte-42bd9dd0.js"]
    }
  ]
};
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${articles ? `${each(articles, (article) => `<div class="${"post-preview"}"><a href="${"blogs/" + escape(article.id)}"><h2 class="${"post-title"}">${escape(article.title)}</h2>
				<div class="${"post-subtitle"}">${escape(article.body)}</div>
			</a></div>
		<hr>`)}
...
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<p>Want to get in touch? Fill out the form below to send me a message and I will get back to you as
	soon as possible!
</p>
<form name="${"sentMessage"}" id="${"contactForm"}" novalidate><div class="${"control-group"}"><div class="${"form-group floating-label-form-group controls"}"><label>Name</label>
			<input type="${"text"}" class="${"form-control"}" placeholder="${"Name"}" id="${"name"}" required data-validation-required-message="${"Please enter your name."}">
			<p class="${"help-block text-danger"}"></p></div></div>
	<div class="${"control-group"}"><div class="${"form-group floating-label-form-group controls"}"><label>Email Address</label>
			<input type="${"email"}" class="${"form-control"}" placeholder="${"Email Address"}" id="${"email"}" required data-validation-required-message="${"Please enter your email address."}">
			<p class="${"help-block text-danger"}"></p></div></div>
	<div class="${"control-group"}"><div class="${"form-group col-xs-12 floating-label-form-group controls"}"><label>Phone Number</label>
			<input type="${"tel"}" class="${"form-control"}" placeholder="${"Phone Number"}" id="${"phone"}" required data-validation-required-message="${"Please enter your phone number."}">
			<p class="${"help-block text-danger"}"></p></div></div>
	<div class="${"control-group"}"><div class="${"form-group floating-label-form-group controls"}"><label>Message</label>
			<textarea rows="${"5"}" class="${"form-control"}" placeholder="${"Message"}" id="${"message"}" required data-validation-required-message="${"Please enter a message."}"></textarea>
			<p class="${"help-block text-danger"}"></p></div></div>
	<br>
	<div id="${"success"}"></div>
	<button type="${"submit"}" class="${"btn btn-primary"}" id="${"sendMessageButton"}">Send</button></form>`;
});
...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.articles === void 0 && $$bindings.articles && articles !== void 0)
    $$bindings.articles(articles);
  return `<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe nostrum ullam eveniet pariatur
...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${article ? `<div class="${"post-preview"}"><a href="${"blogs/" + escape(article.id)}"><h2 class="${"post-title"}">${escape(article.title)}</h2>
			<div class="${"post-subtitle"}">${escape(article.body)}</div></a></div>` : ``}`;
});
...
const Post = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<article><div class="${"container"}"><div class="${"row"}"><div class="${"col-lg-8 col-md-10 mx-auto"}"><p>Never in all their history have men been able truly to conceive of the world as one: a
				...
				<blockquote class="${"blockquote"}">The dreams of yesterday are the hopes of today and the reality of tomorrow. Science has
				...
				<a href="${"#"}"></a>
				<span class="${"caption text-muted"}">To go places and do things that have never been done before \u2013 that\u2019s what living is all
					about.</span>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<nav class="${"navbar navbar-expand-lg navbar-light fixed-top"}" id="${"mainNav"}"><div class="${"container"}"><a class="${"navbar-brand"}" href="${"index.html"}">Start Bootstrap</a>
		<button class="${"navbar-toggler navbar-toggler-right"}" type="${"button"}" data-toggle="${"collapse"}" data-target="${"#navbarResponsive"}" aria-controls="${"navbarResponsive"}" aria-expanded="${"false"}" aria-label="${"Toggle navigation"}">Menu
			<i class="${"fas fa-bars"}"></i></button>
		<div class="${"collapse navbar-collapse"}" id="${"navbarResponsive"}"><ul class="${"navbar-nav ml-auto"}"><li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/."}">Home</a></li>
				<li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/about"}">About</a></li>
				<li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/post"}">Sample Post</a></li>
				<li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/contact"}">Contact</a></li></ul></div></div></nav>`;
});
...
${content ? `<header class="${"masthead"}" style="${"background-image: url('/images/" + escape(content.img_bg) + "')"}"><div class="${"overlay"}"></div>
		<div class="${"container"}"><div class="${"row"}"><div class="${"col-lg-8 col-md-10 mx-auto"}"><div class="${"site-heading"}"><h1>${escape(content.title)}</h1>
						<span class="${"subheading"}">${escape(content.description)}</span></div></div></div></div></header>` : ``}`;
});
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<footer><div class="${"container"}"><div class="${"row"}"><div class="${"col-lg-8 col-md-10 mx-auto"}"><ul class="${"list-inline text-center"}"><li class="${"list-inline-item"}"><a href="${"#"}"><span class="${"fa-stack fa-lg"}"><i class="${"fas fa-circle fa-stack-2x"}"></i>
								<i class="${"fab fa-twitter fa-stack-1x fa-inverse"}"></i></span></a></li>
					<li class="${"list-inline-item"}"><a href="${"#"}"><span class="${"fa-stack fa-lg"}"><i class="${"fas fa-circle fa-stack-2x"}"></i>
								<i class="${"fab fa-facebook-f fa-stack-1x fa-inverse"}"></i></span></a></li>
					<li class="${"list-inline-item"}"><a href="${"#"}"><span class="${"fa-stack fa-lg"}"><i class="${"fas fa-circle fa-stack-2x"}"></i>
								<i class="${"fab fa-github fa-stack-1x fa-inverse"}"></i></span></a></li></ul>
				<p class="${"copyright text-muted"}">Copyright \xA9 Your Website 2020</p></div></div></div></footer>`;
});
var bootstrap = `/*!
...
@font-face {
  ...
  font-weight: 400;
  font-display: block;
  src: url("__VITE_ASSET__6128dd44__");
  src: url("__VITE_ASSET__6128dd44__$_?#iefix__") format("embedded-opentype"), url("__VITE_ASSET__71b3ce72__") format("woff2"), url("__VITE_ASSET__a0375c05__") format("woff"), url("__VITE_ASSET__404d6083__") format("truetype"), url("__VITE_ASSET__e2749cb2__$_#fontawesome__") format("svg"); }
...
@font-face {
  ...
  font-weight: 400;
  font-display: block;
  src: url("__VITE_ASSET__f9853ad3__");
  src: url("__VITE_ASSET__f9853ad3__$_?#iefix__") format("embedded-opentype"), url("__VITE_ASSET__ce20ed8a__") format("woff2"), url("__VITE_ASSET__6799c999__") format("woff"), url("__VITE_ASSET__5e811f0b__") format("truetype"), url("__VITE_ASSET__d42a64dc__$_#fontawesome__") format("svg"); }
...
@font-face {
  ...
  font-weight: 900;
  font-display: block;
  src: url("__VITE_ASSET__e0e3c4af__");
  src: url("__VITE_ASSET__e0e3c4af__$_?#iefix__") format("embedded-opentype"), url("__VITE_ASSET__6b555920__") format("woff2"), url("__VITE_ASSET__aab971ad__") format("woff"), url("__VITE_ASSET__2caded24__") format("truetype"), url("__VITE_ASSET__1a46e780__$_#fontawesome__") format("svg"); }
...
<div class="${"container"}"><div class="${"row"}"><div class="${"col-lg-8 col-md-10 mx-auto"}">${slots.default ? slots.default({}) : ``}</div></div></div>
